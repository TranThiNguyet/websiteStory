...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Cập nhật tài khoản</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary">
                <?php
                // Hiển thị thông tin
                $user_id = $_SESSION['infoUser']['user_id'];
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $query = "UPDATE users SET email = '{$email}', fullname = '{$fullname}', phone = '{$phone}', address = '{$address}', birthday = '{$birthday}', avatar= '{$avatar}' WHERE user_id = {$user_id}";
                    if ($password) {
                        $password = md5($password);
                        $query = "UPDATE users SET email = '{$email}', password = '{$password}', fullname = '{$fullname}', phone = '{$phone}', address = '{$address}', birthday = '{$birthday}', avatar= '{$avatar}' WHERE user_id = {$user_id}";
                    }
